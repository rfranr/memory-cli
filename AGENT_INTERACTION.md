...
[ ] - add tests around categoryEmbeddingText, metadata parsing, empty category DB, and chunking behavior (decision documented in docs/adr/0002-testing-strategy.md)
